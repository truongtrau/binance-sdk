...
var encodeAddress = function encodeAddress(value) {
  ...
  // console.log('5.1 word from bech buffer :' +words)
  // console.log('5.1.1 type:'+type)
  // console.log('5.1.2 prefix:'+prefix)
  // console.log('5.2 address from bech encode: '+_bech["default"].encode(prefix, words) )
...
var getAddressFromPublicKey = function getAddressFromPublicKey(publicKeyHex, prefix) {
  ...
  //console.log('2. Publickey:'+publicKeyHex)  
  var pubKey = ec.keyFromPublic(publicKeyHex, "hex");
  var pubPoint = pubKey.getPublic();  
  var compressed = pubPoint.encodeCompressed();  
  //console.log('3. compressed:' +compressed)
  //console.log('compressed hex :' + Buffer.from(compressed).toString("hex"))  
  var hexed = (0, _utils.ab2hexstring)(compressed);
  //console.log('4. compressed hex:' +hexed)
...
console.log('9.1 crypto/signature hex')
console.log(signature.toString("hex"))
console.log('9.2 crypto/signature')
console.log(signature)
console.log('9.3. crypto/sign: ' +JSON.stringify(signature))
