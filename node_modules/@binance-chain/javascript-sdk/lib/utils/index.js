...
var sha256ripemd160 = function sha256ripemd160(hex) {
  ...
  console.log('4.1.1 hexEncoded: ' + hexEncoded)
  var ProgramSha256 = (0, _sha2["default"])(hexEncoded);
  console.log('4.2 Sha256: ' +ProgramSha256)
  var ripm  = (0, _ripemd["default"])(ProgramSha256).toString();
  console.log('4.3 ripemd: '+ ripm)
  var rel = (0, _ripemd["default"])(ProgramSha256).toString();
  console.log('4.4 ripemd: '+rel)
  return rel
};
/**
...
var sha256 = function sha256(hex) {
  ...
  var hexEncoded = _encHex["default"].parse(hex);
  console.log('hex endcoded:'+ hexEncoded)
