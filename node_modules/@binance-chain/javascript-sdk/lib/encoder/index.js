...
var convertObjectToSignBytes = function convertObjectToSignBytes(obj) {
   console.log('input endcode')
   console.log('sortObject',sortObject(obj))
   console.log('Input [',JSON.stringify(sortObject(obj),']'))
  let res  = _safeBuffer.Buffer.from(JSON.stringify(sortObject(obj)));
  // console.log('output buffer')
  console.log("output",res.toString("hex"));
  return res
};
/**
