    ...
    return _regenerator["default"].wrap(function _callee$(_context) {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 1:
          case "end":{
              // console.log("DefaultSigningDelegate")
              // console.log(_context)
          ...
          while (1) {
            switch (_context9.prev = _context9.next) {
              ...
              case 15:
                ...
                console.log('#accCodexx')
                console.log(accCode)
                console.log(accCode.toString('hex'))
          ...
          while (1) {
            switch (_context11.prev = _context11.next) {
              case 0:
                ...
                _context11.next = 5;
                console.log("get", "".concat(api.getAccount, "/").concat(address))
                return this._httpClient.request("get", "".concat(api.getAccount, "/").concat(address));
              ...
              case 13:
                ...
                console.log('5. tx')
                console.log(tx)
                console.log('6. stdSignMsg')
                console.log(stdSignMsg)
                let t =_context11.abrupt("return", this._signingDelegate.call(this, tx, stdSignMsg));               
                return t
