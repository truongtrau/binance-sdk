...
function () {
  function Transaction(data) {
    ...
    console.log('tx/data.msg: ' + JSON.stringify( data.msg))
    this.msgs = data.msg ? [data.msg] : [];
    console.log('m1: '+ JSON.stringify( this.msgs))
    this.memo = data.memo;
  }
  /**
  ...
  (0, _createClass2["default"])(Transaction, [{
    ...
    value: function getSignBytes(msg) {
      ...
      console.log('7.1 SignMsg')
      console.log(signMsg)
      console.log('7.2 Encoder to buffer')
    ...
    value: function addSignature(pubKey, signature) {
      ...
      //console.log('pubKeyhex:'+Buffer.from(pubKey, "hex"))
      
      pubKey = this._serializePubKey(pubKey); // => Buffer
      
      console.log('pubKeyhex:'+pubKey.toString('hex'))
    ...
    value: function serialize() {
      ...
      console.log('tx/msg hex: '+msg.toString('hex'))
      console.log('tx/msg: '+(JSON.stringify(msg)))
      console.log('tx/signatures hex: '+(JSON.stringify(this.signatures.toString('hex'))))
      console.log('tx/signatures: '+(JSON.stringify(this.signatures)))
      console.log('tx/stdTx: '+(JSON.stringify(stdTx)))
